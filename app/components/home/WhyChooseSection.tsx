    ...
    <section className="relative py-24 lg:py-32 bg-[#0d3b35] text-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 mb-12">
          {/* Card 1 */}
          <div className="bg-[#0d3b35] border border-white/10 rounded-2xl p-6 hover:bg-[#0a2e2a] transition-colors">
            <div className="mb-4">
        ...
        <div className="text-center">
          <button className="px-8 py-3 bg-white text-[#0d3b35] rounded-lg font-semibold hover:bg-gray-100 transition-colors">
            Começar agora
          </button>
        </div>
      </div>
