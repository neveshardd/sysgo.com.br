      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="p-8 rounded-2xl bg-[#f8f9fa] border border-gray-100 hover:bg-white hover:shadow-lg transition-all">
            ...
            <h3 className="text-lg font-bold text-[#0d3b35] mb-3">Hospedagem Escalável</h3>
          ...
          <div className="p-8 rounded-2xl bg-[#f8f9fa] border border-gray-100 hover:bg-white hover:shadow-lg transition-all">
            ...
            <h3 className="text-lg font-bold text-[#0d3b35] mb-3">Registro e Renovação de Domínio</h3>
            <p className="text-gray-500 text-sm leading-relaxed">
          ...
          <div className="p-8 rounded-2xl bg-[#FDF4D0] border border-transparent hover:shadow-lg transition-all rounded-tr-[3rem]">
            ...
            <h3 className="text-lg font-bold text-[#0d3b35] mb-3">Painel Administrativo Simples</h3>
          ...
          <div className="p-8 rounded-2xl bg-[#f8f9fa] border border-gray-100 hover:bg-white hover:shadow-lg transition-all">
            ...
            <h3 className="text-lg font-bold text-[#0d3b35] mb-3">Certificado SSL (Https)</h3>
            <p className="text-gray-500 text-sm leading-relaxed">
          ...
          <div className="p-8 rounded-2xl bg-[#f8f9fa] border border-gray-100 hover:bg-white hover:shadow-lg transition-all md:col-span-2 lg:col-span-2">
            ...
            <h3 className="text-lg font-bold text-[#0d3b35] mb-3">E-mails Corporativos</h3>
